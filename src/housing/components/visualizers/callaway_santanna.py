...
class CallawaySantAnnaVisualizer(Visualizer):
    ...
    def __init__(
        ...
        Args:
            ...
            context_suffix: Suffix for context keys (e.g. "_with_controls" for
                cs_event_study_with_controls, cs_overall_att_with_controls).
            output_suffix: Suffix for output filenames (e.g. "_with_controls").
        """
        super().__init__(
    ...
    def execute(self, context: dict[str, Any]) -> dict[str, Any]:
        ...
        # 2. Comparison with TWFE (base CS only; avoids duplicating baseline plots)
        ...
        # 3. Cohort-specific dynamics (base CS only)
        if not self.context_suffix:
