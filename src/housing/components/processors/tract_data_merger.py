"""Tract data merger processor.

This module merges multiple tract-level datasets together for clustering analysis.
It combines rental data, Airbnb data, STR prohibition data, census data,
affordable development data, and foreclosed data into a single merged dataset.
"""
...
class TractDataMerger(DataProcessor):
