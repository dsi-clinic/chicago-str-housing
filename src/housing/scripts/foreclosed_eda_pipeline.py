...
from housing.components.visualizers.foreclosed_distribution import ForeclosedDistributionVisualizer
...
if __name__ == "__main__":
    ...
    logger.info("\n" + "=" * 70)
    logger.info("Foreclosed EDA Pipeline Complete. Check the output/ directory for visualizations")