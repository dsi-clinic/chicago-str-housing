...
Treat the **dashboard** ([`dashboard/`](dashboard/)) as a **companion** to the paper (methodology audit, Love plots, lineage)—not the primary archival surface for estimates.
